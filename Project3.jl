...
begin
	tr= []
	tr_newton([2.0, 2.0],himmelblau,f,j,monitor=(x, rnorm, μ)->push!(tr, rnorm))
end


# ╔═╡ 0efc13f8-18f9-42ee-9e28-891e69abb32a
plot(tr, yscale=:log10)
...
# ╔═╡ 410dae72-1590-4492-9d66-ca1ac4346022
md"""
...
test_sample("Uniform",q1)

# ╔═╡ f321ca35-a619-48f8-bdc9-48e892e02ea5
test_sample("Random",q2)

# ╔═╡ 5d2f5363-de50-4a8f-b9e5-ed19c4e924d5
test_sample("Quasi-Random",q3)

# ╔═╡ c128c068-e41b-41c4-b774-e443cd08ecd7
test_sample("Uniform",q1,xx_data,y_data)

# ╔═╡ 7aa8015a-54c7-4639-a76f-0b42fba6ff69
test_sample("Random",q2,xx_data,y_data)

# ╔═╡ 26347667-03e4-4914-a2a1-89dd54338765
test_sample("Quasi-Random",q3,xx_data,y_data)
